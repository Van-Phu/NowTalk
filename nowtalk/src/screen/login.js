            ...
            <div className='formLogin'>
                ...
                <div className='input'>
                    ...
                    <div className='inputType'>
                        ...
                        <input value={username} onChange={handleGetValueUsername} style={{height: 30, width: '100%', marginRight: 10, background: "#190733", border: 0, color: "#A4A4A4"}}></input>
                    </div>
                </div>
                ...
                <div className='input'>
                    ...
                    <div className='inputType'>
                        ...
                        <input value={password} onChange={handleGetValuePassword} style={{height: 30, width: '100%', marginRight: 10, background: "#190733", border: 0, color: "#A4A4A4"}}></input>
                    </div>
                </div>
